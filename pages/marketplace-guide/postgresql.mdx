...
Spheron allows you to deploy a compute instance pre-installed with PostgreSQL, all set up and ready to use.
...
10. Next, Add "User","Password" and "Database" under **Template Configuration**. Spheron has made it easy and auto-filled the configuration options. You can add advanced configurations if required. [Click here](/compute/cluster/compute/#advance-configuration-1) to know more.
